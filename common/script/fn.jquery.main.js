...
$(document).ready(function(){
    ...
    var n = d.getUTCDay();
		...
		if(n===0){
			//default
			$("body, body#main").css("background-image", "url(/images/v-red.png)");
	    	var wkSlog = "Code Web UI with a Passion for Marketing";
	    	return wkSlog;
	    	}
	
	    else if(n===1){
			$("body, body#main").css("background-image", "url(/images/v-green.png)");
	        ...
	        $("body, body#main").css("background-image", "url(/images/v-blue.png)");
	        ...
	        $("body, body#main").css("background-image", "url(/images/v-gray.png)");
	    	//$(".category").css("background-image", "url(/images/bigback8.svg)");
	    	//$("nav.orangebar").css("background", "#000");
...
// ++++++++++++++++++++++ Shared Core Global Functions ++++++++++++++++++++
	...
	var fnNavHome = function(a, b, c, d, e){
		...
		$("#bigHallGalleryTab").css({"display":"none", "top":"10px"});
	};
		...
		//
			...
			$("#scrollL").hover(function() {
				...
				if (objOffset.left > 0 + vMLeft) {
					fnAddClass("#home, #thumb1", "outlineOn");
					$("#categories").css("margin-left", "0" + "px");
					$("#scrollL").css("visibility","hidden");
				}

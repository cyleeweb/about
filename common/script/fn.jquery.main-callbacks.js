...
$(document).ready(function(){
	...
	$('body#main').fadeIn('fast', function(){
		...
		// Init Callbacks Begins...
		$('#init').fadeIn(4500, function(){
			...
			$("#aboutnav, #aboutsubtab, #exhibitnav, #exhibit1, #exhibit1, #exhibit2, #exhibit3, #exhibit4, #exhibit5, #exhibit6, #exhibit7, #exhibit7, #moreproductions-link, .enterprise, #modulesNavset, #projector, #screen #prev, #screen #slider, #screen i").click(function(event){
		    ...
		    $('#categories').fadeIn(1000, function(){
		    	$('.sectitle, .byline, #collapse').fadeIn(1000);
		    });
		...
		*/
			...
			$("#domtraversing").bind("change", function(){
				...
				switch(n) {
					...
					case '12':
						...
						alert("The meta information (content) of this document:"+ (dom12[i].getAttribute("content")));
						}
						break;
				}
				$(this).val('0');
		...
		// console.log(objOffset.left); // moving object's left position
			...
			$('#thumb1, #home').bind("click tap", function(){
				window.scrollTo(0,0);
				$('#categories').animate({marginLeft:0 + vMLeft}, 250, "linear");
			...
			$('#thumb2, #about').bind("click tap", function(){
				window.scrollTo(0,0);
				$('#categories').animate({marginLeft:-801 + vMLeft}, 250, "linear");
				$("#orangebarTop .i").removeClass("outlineOn");
			...
			$('#thumb3, #gallery').bind("click tap", function(){
				window.scrollTo(0,0);
				$('#categories').animate({marginLeft:-1602 + vMLeft}, 250, "linear");
				$("#orangebarTop .i").removeClass("outlineOn");
			...
			$('#thumb4, #samples').bind("click tap", function(){
				window.scrollTo(0,0);
				$('#categories').animate({marginLeft:-2403 + vMLeft}, 250, "linear");
				$("#orangebarTop .i").removeClass("outlineOn");
			...
			$('#thumb5, #modules').bind("click tap", function(){
				window.scrollTo(0,0);
				$('#categories').animate({marginLeft:-3204 + vMLeft}, 250, "linear");
				$("#orangebarTop .i").removeClass("outlineOn");
			...
			$('#thumb6, #videos').bind("click tap", function(){
				window.scrollTo(0,0);
				$('#categories').animate({marginLeft:-4005 + vMLeft}, 250, "linear");
				$("#orangebarTop .i").removeClass("outlineOn");

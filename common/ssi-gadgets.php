<div id="gadgets">
	<div id="themeControl-x" class="" title="Drag Any Carousel Theme In-&-Out Here"></div>
	<div id="themeControl-1" class="" title="Toggle Carousel Theme One"></div>
	<div id="themeControl-2" class="" title="Toggle Carousel Theme Two"></div>
	...
	<select id='spahashpower'>
	    ...
	    <option value="#/exhibit/4" title="#/exhibit/4">#/exhibit/4</option>
	    <option value="#/exhibit/5" title="#/exhibit/5">#/exhibit/5</option>
	    <option value="#/exhibit/6" title="#/exhibit/6">#/exhibit/6</option>
	    <option value="#/exhibit/7" title="#/exhibit/7">#/exhibit/7</option>
	    <option value="#/exhibit/8" title="#/exhibit/8">#/exhibit/8</option>
	    <option value="#/exhibit/all" title="#/exhibit/all">#/exhibit/all</option>
	</select>
	...
	<select id='entryqueries'>
	    ...
	    <option value="entry=samples" title="entry=samples">entry=samples</option>
	    <option value="entry=modules" title="entry=modules">entry=modules</option>
	    <option value="entry=videos" title="entry=videos">entry=videos</option>
	</select>
	...
	<select id='javascript' title="Javascript">
		...
		<option value="4" title="Scope & Closure Factories">Scope & Closure Factories</option>
		<option value="5" title="Call-Apply-Bind">Call-Apply-Bind</option>
		<option value="6" title="Callback">Callback</option>
	...
	<div id="cl-guestbookapp" class="codelinks" title="SPA Guestbook App (PHP+MySQL)">
		<a href="/mysql/console-guestbook.php" target="_blank">SPA REST App A (PHP+MySQL)</a>
	</div>
	
	<div id="cl-mongolab-bookstore" class="codelinks" title="SPA Bookstore App (NonSQL Mongolab)">
		<a href="/mongolab/bookstore/index.php" target="_blank">SPA REST App B (NonSQL Mongolab)</a>
	</div>
	
	<div id="cl-mongolab-taskmanager" class="codelinks" title="SPA Taskmanager App (NonSQL Mongolab)">
